...
visitors → Free TG channel join → upgrade to Pro Alerts ($9) → Signal
Pro ($39) → higher tiers.
...
<meta name="description" content="Sub-second crypto + equity signals from a multi-strategy fleet. Free tier on Telegram. Pro tiers from $9.">
<style>
  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <p class="quietnote">
        ...
        Pro+ tier includes daily Brier-score rollups and Sharpe per
        strategy — you can audit edge before you trade it.
      </p>
    </div>
  </div>
  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <ul class="features">
        ...
        <li>Real-time, no delay</li>
      </ul>
      <a href="{pro_url}" class="cta">Start Pro Alerts</a>
    </div>
    ...
    <div class="card">
      ...
      <ul class="features">
        <li>Everything in Pro Alerts</li>
        <li>Private TG group: every chainlink-lag emit</li>
        <li>Polymarket sell-wings + publisher-taker</li>
      </ul>
      <a href="{pro_url}" class="cta">Start Signal Pro</a>
    </div>
    ...
    <div class="card">
      ...
      <ul class="features">
        <li>Everything in Signal Pro</li>
        <li>GMX liquidation alerts</li>
        <li>News-driven Polymarket triggers</li>
        <li>Daily Brier + Sharpe rollups</li>
      </ul>
    ...
    <div class="card">
      ...
      <ul class="features">
        ...
        <li>Up to 5,000 triggers</li>
        <li>REST API access</li>
        <li>White-label rights</li>
      </ul>
      <a href="{pro_url}" class="cta secondary">Contact us</a>
    </div>
  </div>
